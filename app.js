...
const defectsSeed = [
    ...
    { id: 3, dateReport: "2026-06-02", timeReport: "03:46", plate: "N°4", driver: "ARAUJO QUISPE EDGAR", description: "JEBE LATERAL PARA CAMBIO", system: "OTRO", severity: "MODERADO", dateRepair: "", timeRepair: "", status: "PENDIENTE", obs: "SE SOLICITO EL JEBE", daysStop: "" },
    ...
    { id: 5, dateReport: "2026-06-02", timeReport: "22:23", plate: "BWP-886", driver: "MARRON BALDEON JOSE MANUEL", description: "Roto puño de la base del piston hidraulico", system: "HIDRÁULICO", severity: "GRAVE", dateRepair: "2026-06-02", timeRepair: "23:45", status: "REPARADO", obs: "", daysStop: "1 hora y 22 min" },
    { id: 6, dateReport: "2026-06-03", timeReport: "09:13", plate: "BZU-913", driver: "QUISPE PERALES CHRISTHIAN AMERICO", description: "Rotura de manguera hidraulica", system: "HIDRÁULICO", severity: "MODERADO", dateRepair: "2026-06-03", timeRepair: "12:00", status: "REPARADO", obs: "Auxilio Freddy Reyes", daysStop: "2 horas y 47 min" },
    { id: 7, dateReport: "2026-06-03", timeReport: "10:52", plate: "BWR-724", driver: "ALCCA CCAHUANA NEPTALI ROLANDO", description: "Fuga aceite del motor", system: "MOTOR", severity: "MODERADO", dateRepair: "2026-06-03", timeRepair: "11:22", status: "REPARADO", obs: "Auxilio mecanico", daysStop: "30 min" },
    { id: 8, dateReport: "2026-06-03", timeReport: "13:18", plate: "BWR-724", driver: "ALCCA CCAHUANA NEPTALI ROLANDO", description: "Bolsa de aire del asiento del piloto defectuosa", system: "OTRO", severity: "LEVE", dateRepair: "2026-06-03", timeRepair: "14:20", status: "REPARADO", obs: "", daysStop: "1 hora y 2 min" },
    { id: 9, dateReport: "2026-06-04", timeReport: "09:37", plate: "BWQ-863", driver: "MARRON BALDEON JOSE MANUEL", description: "Resume hidrolina por cañeria de metal del techo", system: "HIDRÁULICO", severity: "GRAVE", dateRepair: "", timeRepair: "", status: "EN TALLER", obs: "INGRESA 15:43", daysStop: "" },
    { id: 10, dateReport: "2026-06-04", timeReport: "09:52", plate: "BZU-913", driver: "ROBLES GORA SANTIAGO", description: "Fuga de lixiviado por llave de paso de la tina", system: "OTRO", severity: "MODERADO", dateRepair: "2026-06-04", timeRepair: "14:16", status: "REPARADO", obs: "", daysStop: "4 horas y 24 min" },
    { id: 11, dateReport: "2026-06-05", timeReport: "07:34", plate: "N°1", driver: "JERI CHAVEZ GUSTAVO ORLANDO", description: "Fuga en caja de cambios, nivel bajo", system: "MOTOR", severity: "MODERADO", dateRepair: "", timeRepair: "", status: "EN REPORTE", obs: "", daysStop: "" },
    { id: 12, dateReport: "2026-06-05", timeReport: "06:31", plate: "BZV-736", driver: "QUISPE PERALES CHRISTHIAN AMERICO", description: "Manija interna de puerta del conductor malograda", system: "OTRO", severity: "LEVE", dateRepair: "", timeRepair: "", status: "EN REPORTE", obs: "", daysStop: "" },
    { id: 13, dateReport: "2026-06-05", timeReport: "07:34", plate: "BWR-724", driver: "TUPAC VILLEGAS ROBBY", description: "Rotura de guardabarros posterior derecho", system: "OTRO", severity: "LEVE", dateRepair: "", timeRepair: "", status: "EN REPORTE", obs: "", daysStop: "" }
];
...
function initDatabase() {
    ...
    if (dbVer !== currentVer) {
        // One-time database reset to start at 0 reports as requested
    ...
    if (localFleet && localDrivers && localDefects) {
        ...
        // Load Seed Data (Start with 0 defects)
        state.fleet = [...fleetSeed];
        state.drivers = [...driversSeed];
        state.defects = []; // Iniciar en 0
        saveToLocalStorage();
    }
